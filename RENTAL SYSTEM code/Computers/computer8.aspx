<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="computer8.aspx.cs" Inherits="computer8" Title="
List of Computers Vendors in Chennai" %>
                    ...
                    <tr>
                        <td style="width: 100px">
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 148px; position: absolute; top: 64px" Text="Pradeep Sachdeva, Tel 9999843327"
                            ...
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Italic="False"
                                Font-Size="Small" ForeColor="Red" NavigateUrl="~/Computers/computer products1.aspx" Style="z-index: 105;
