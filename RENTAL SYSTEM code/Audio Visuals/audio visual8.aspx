<%@ Page Language="C#" MasterPageFile="~/Audio Visuals/AudioVisuval.master" AutoEventWireup="true" CodeFile="audio visual8.aspx.cs" Inherits="audio_visual8" Title="List of AudioVisuals Vendors in Chennai" %>
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Audio Visuals>>Chennai" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px; height: 93px;">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 152px; position: absolute; top: 11px"
                                Text="Chennai Rental Showrooms , " Width="235px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 428px; position: absolute; top: 15px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 155px; position: absolute; top: 64px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 1px; position: absolute;
                                top: 1px" Width="140px" Height="94px" ImageUrl="~/images/Chennai rentals.jpg" />
