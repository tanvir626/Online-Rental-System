<%@ Page Language="C#" MasterPageFile="~/Audio Visuals/AudioVisuval.master" AutoEventWireup="true" CodeFile="booking.aspx.cs" Inherits="booking" Title="Booking" %>
...
// ]]>
    ...
    <asp:Button ID="btnbooknow" runat="server" Style="z-index: 100; left: 319px; position: absolute;
        top: 656px" Text="BookNow" TabIndex="19" OnClick="btnbooknow_Click" />
    &nbsp;<br />
    <br />
    <br />
        ...
        <tr>
            ...
            <td style="width: 100px">
                ...
                <asp:ImageButton ID="ImageButton1" runat="server" Height="30px" ImageUrl="~/images/ktt_cal.gif"
                    Style="z-index: 104; left: 426px; position: absolute;
                    top: 169px" Width="31px" OnClick="ImageButton1_Click" ValidationGroup="c1" TabIndex="9" />
            </td>
        </tr>
        <tr>
            ...
            <td style="width: 100px; height: 23px">
                ...
                <asp:DropDownList ID="ddlam" runat="server" Style="z-index: 101; left: 334px;
                    position: absolute; top: 221px" Width="63px" TabIndex="13">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator8" runat="server" ControlToValidate="ddlam"
                    ...
                    top: 219px" Width="5px">*</asp:RequiredFieldValidator><asp:DropDownList ID="ddlhours" runat="server" Style="z-index: 104; left: 179px;
        ...
        <tr>
            ...
            <td style="width: 100px">
                ...
                <asp:ImageButton ID="ImageButton2" runat="server" Height="30px" ImageUrl="~/images/ktt_cal.gif"
                    Style="z-index: 102; left: 423px; position: absolute; top: 255px" Width="34px" OnClick="ImageButton2_Click" ValidationGroup="c2" TabIndex="15" />
            </td>
        </tr>
        <tr>
