<%@ Page Language="C#" MasterPageFile="~/Audio Visuals/AudioVisuval.master" AutoEventWireup="true" CodeFile="searchresults.aspx.cs" Inherits="searchresults" Title="Search Results" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:GridView ID="GridView1" runat="server" BackColor="#DEBA84" BorderColor="#DEBA84"
        ...
        left: 48px; position: absolute; top: 212px">
        <Columns>
