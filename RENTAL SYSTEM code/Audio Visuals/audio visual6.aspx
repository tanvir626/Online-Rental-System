<%@ Page Language="C#" MasterPageFile="~/Audio Visuals/AudioVisuval.master" AutoEventWireup="true" CodeFile="audio visual6.aspx.cs" Inherits="audio_visual6" Title="List of AudioVisuals Vendors in Kolkata" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 37px; width: 911px; position: absolute;
        top: 197px; height: 286px">
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Audio Visuals>>Kolkata" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 135px; position: absolute; top: 9px"
                                Text="Kolkata Rental Showrooms , " Width="204px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 399px; position: absolute; top: 12px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 137px; position: absolute; top: 60px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 2px; position: absolute;
                                top: 4px" Width="124px" Height="86px" ImageUrl="~/images/kolkata rentals.JPG" />
