<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="car3.aspx.cs" Inherits="car3" Title="List of Cars Vendors in Delhi" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 48px; width: 911px; position: absolute;
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Cars>>Delhi" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 387px; position: absolute; top: 12px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 139px; position: absolute; top: 63px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 1px; position: absolute;
                                top: 2px" Width="132px" Height="94px" ImageUrl="~/images/delhi rental showrm.jpg" />
