<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="car5.aspx.cs" Inherits="car5" Title="List of Cars Vendors in Ahmedabad " %>
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Cars>>Ahemadabad" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 129px; position: absolute; top: 10px"
                                Text="Ahemadabad Rental Showrooms , " Width="255px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 405px; position: absolute; top: 10px"
                            ...
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 3px; position: absolute;
                                top: 3px" Width="119px" Height="92px" ImageUrl="~/images/ahmedabad rentals.JPG" />
