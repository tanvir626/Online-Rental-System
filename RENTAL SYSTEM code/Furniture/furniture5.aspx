<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="furniture5.aspx.cs" Inherits="furniture5" Title="
List of Furniture Vendors in Ahmedabad" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 59px; width: 911px; position: absolute;
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Furniture>>Ahemadabad" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 145px; position: absolute; top: 15px"
                                Text="Ahemadabad Rental Showrooms , " Width="246px"></asp:Label>
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 418px; position: absolute; top: 16px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 149px; position: absolute; top: 61px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 0px; position: absolute;
                                top: 5px" Width="135px" Height="87px" ImageUrl="~/images/ahmedabad rentals.JPG" />
                            <asp:HyperLink ID="HyperLink1" runat="server" Font-Bold="True" Font-Italic="False"
                                Font-Size="Small" ForeColor="Red" NavigateUrl="~/Furniture/furniture products1.aspx" Style="z-index: 105;
