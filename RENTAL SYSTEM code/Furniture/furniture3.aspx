<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="furniture3.aspx.cs" Inherits="furniture3" Title="
List of Furniture Vendors in Delhi" %>
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Furniture>>Delhi" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 359px; position: absolute; top: 14px"
                            ...
                            <asp:Label ID="Label5" runat="server" ForeColor="MediumBlue" Style="z-index: 102;
                                left: 121px; position: absolute; top: 63px" Text="Pradeep Sachdeva, Tel 9999843327"
                                Width="233px"></asp:Label>
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 2px; position: absolute;
                                top: 5px" Width="110px" Height="88px" ImageUrl="~/images/delhi rental showrm.jpg" />
