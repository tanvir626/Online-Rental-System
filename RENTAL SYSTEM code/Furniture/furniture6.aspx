<%@ Page Language="C#" MasterPageFile="~/HomePage.master" AutoEventWireup="true" CodeFile="furniture6.aspx.cs" Inherits="furniture6" Title="List of Furniture Vendors in Kolkata" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <br />
    <br />
    <table border="1" style="z-index: 101; left: 60px; width: 911px; position: absolute;
        ...
        <tr>
            <td style="width: 100px">
                <asp:Label ID="Label1" runat="server" Font-Bold="True" Style="z-index: 100; left: 3px;
                    ...
                    Text="Vendor Search Result >> Furniture>>Kolkata" Width="910px"></asp:Label>
                    ...
                    <tr>
                        <td style="width: 100px">
                            <asp:Label ID="Label3" runat="server" Font-Bold="True" Font-Names="Arial" Font-Size="Smaller"
                                ForeColor="#0000C0" Style="z-index: 100; left: 136px; position: absolute; top: 9px"
                            ...
                            <asp:Label ID="Label4" runat="server" Font-Italic="False" Font-Underline="False"
                                ForeColor="#0000C0" Style="z-index: 101; left: 377px; position: absolute; top: 10px"
                            ...
                            <asp:Image ID="Image1" runat="server" Style="z-index: 103; left: 3px; position: absolute;
                                top: 4px" Width="125px" Height="91px" ImageUrl="~/images/kolkata rentals.JPG" />
